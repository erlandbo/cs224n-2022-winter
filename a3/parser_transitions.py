...
def minibatch_parse(sentences, model, batch_size):
    ...
    while unfinished_parses:
        ...
        for partial_parser, transition in zip(minibatch, transitions): partial_parser.parse_step(transition)
        unfinished_parses = [pparser for i, pparser in enumerate(unfinished_parses) if pparser.buffer or len(pparser.stack)>1]

    dependencies = [pparser.dependencies for pparser in partial_parses]
    ### END YOUR CODE
